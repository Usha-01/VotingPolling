          ...
          {/* <div className="container">
            ...
            <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
              <ul className="navbar-nav ml-auto">
                ...
                <li>
                     {!user.email?<Link to='/login1' class="link-active">Logout</Link>:
...
{/* 
        ...
        <List>
        <ListItem  disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/Management")}}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
    ...
    <Divider />
        ...
        <ListItem  disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/Totalvote")}}>
              ...
              >
                ...
                <ListItemText primary="Totalvote" sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
            </ListItem>
        </List>
